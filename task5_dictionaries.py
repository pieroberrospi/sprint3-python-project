...
# c)
number_one_game = video_game_sales[0]

top_game = {
    'name': number_one_game[NAME],
    'year': number_one_game[YEAR],
    'genre': number_one_game[GENRE],
    'publisher': number_one_game[PUBLISHER],
    'global_sales': number_one_game[GLOBAL_SALES]
}
